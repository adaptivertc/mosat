...
#define HUM_LO(silo_start) (*silo_start)
...
unsigned short config[200] = {5, 
   68, 75, 20, 32, 0, 0, 0, 1, 2, /*1*/ 0, 0, 0, 2,  /*2*/ 0, 1, 0, 2, 
   70, 76, 20, 32, 0, 2, 0, 3, 4, /*1*/ 0, 3, 0, 7,  /*2*/ 0, 4, 0, 7, /*3*/ 0, 5, 0, 7, /*4*/ 0, 6, 0, 7,
   68, 75, 20, 32, 0, 4, 0, 5, 2, /*1*/ 0, 8, 0, 10,  /*2*/ 0, 9, 0, 10,
   /* next modbus */
   68, 75, 20, 32, 5, 0, 5, 1, 2, /*1*/ 5, 0, 5, 2,  /*2*/ 5, 1, 5, 2,
   69, 76, 20, 32, 5, 2, 5, 3, 3, /*1*/ 5, 3, 5, 6,  /*2*/ 5, 4, 5, 6, /*3*/ 5, 5, 5, 6,
};
// number of silos
// 
// For each silo
...
Every fan must have its own ON discrete output
...
void print_info(void)
{
  ...
  for (int i=0; i < n_silos; i++)
  {
    ...
    {
      printf("    %d: ON mod: %hu, ON ch: %hu, OFF mod: %hu,  OFF ch: %hu\n", j,
