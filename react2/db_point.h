...
public:
  ...
  virtual secuencia_step_t *get_secuencia_step(int argc, char *argv[], 
                      char *err_str, int esize)
  ...
  virtual void init_values(void) = 0;
...
/*#SCRIPT_OBJECT#(INTEGER_VALUE_POINT)*/
class int_value_point_t : public integer_point_t
{
private:
  int initial_value;
