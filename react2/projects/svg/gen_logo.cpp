...
void gen_imasa_logo(FILE *fp, double x, double y, double height, double width)
{
  ...
  fprintf(fp, "  <defs>\n");
  fprintf(fp, "    <linearGradient id=\"xgrLinearBlue\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\" spreadMethod=\"pad\" gradientUnits=\"objectBoundingBox\">\n");
  ...
  fprintf(fp, "    <linearGradient id=\"xgrLinearGrey\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\" spreadMethod=\"pad\" gradientUnits=\"objectBoundingBox\">\n");
  fprintf(fp, "      <stop offset=\"0%%\" stop-color=\"lightgrey\" stop-opacity=\"1\"/>\n");
  fprintf(fp, "      <stop offset=\"100%%\" stop-color=\"grey\" stop-opacity=\"1\"/>\n");
  fprintf(fp, "    </linearGradient>\n");
  fprintf(fp, "    <linearGradient id=\"xgrLinearWhite\" x1=\"0%%\" y1=\"0%%\" x2=\"0%%\" y2=\"100%%\" spreadMethod=\"pad\" gradientUnits=\"objectBoundingBox\">\n");
  fprintf(fp, "      <stop offset=\"0%%\" stop-color=\"lightgrey\" stop-opacity=\"1\"/>\n");
  ...
  fprintf(fp, "  style=\"fill:url(#xgrLinearBlue);stroke:none;stroke-width:0\"/>\n");
  ...
  fprintf(fp, "<polygon points=\"%lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf\"\n",
           ...
           x + halfx, 
           y + height);
  fprintf(fp, "  style=\"fill:url(#xgrLinearGrey);stroke:none;stroke-width:0\"/>\n");
  ...
  fprintf(fp, "<polygon points=\"%lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf %lf,%lf\"\n",
           ...
           x + (halfx * fbota), 
           y + halfy + (halfy * fbota) );
  fprintf(fp, "  style=\"fill:url(#xgrLinearWhite);stroke:none;stroke-width:0\"/>\n");
